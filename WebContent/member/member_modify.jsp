			...
			<table width="600" align="center" class="outline">
				...
				<tr>
  				...
  				<tr>
					...
					<td class="m3">
						<input type="text" name="ssn1" class="box" value="<%=dto.getPasswd()%>" maxLength="6" readOnly> -
				<input type="password" name="ssn2" class="box" value="<%=dto.getPasswd()%>" maxLength="7" readOnly >
					</td>
  				</tr>
  				<tr>
